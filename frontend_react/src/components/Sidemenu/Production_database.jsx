...
class Prodution extends Component {
  ...
  render() {
    ...
    const Traceability =
      data && data.api_Production
        ? data.api_Production.filter((item) => item.Details === "Traceability")
        : [];

    const Monitoring =
      data && data.api_Production
        ? data.api_Production.filter((item) => item.Details === "Monitoring")
        : [];

    const Report =
      data && data.api_Production
        ? data.api_Production.filter((item) => item.Details === "Report")
        : [];

    const Analysis_requester =
      data && data.api_Production
        ? data.api_Production.filter(
