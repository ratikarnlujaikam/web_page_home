...
class Data_analysis extends Component {
  ...
  render() {
    ...
    const Traceability =
      data && data.api_Data_analysis
        ? data.api_Data_analysis.filter((item) => item.Details === "Traceability")
        : [];

    const Monitoring =
      data && data.api_Data_analysis
        ? data.api_Data_analysis.filter((item) => item.Details === "Monitoring")
        : [];

    const Report =
      data && data.api_Data_analysis
        ? data.api_Data_analysis.filter((item) => item.Details === "Report")
        : [];

    const Analysis_requester =
      data && data.api_Data_analysis
        ? data.api_Data_analysis.filter(
